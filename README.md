...
Crie uma nova branch para sua contribuição: git checkout -b feature/adiciona-nova-ia.

Adicione o novo modelo ou faça as correções necessárias no arquivo de dados (ex: dados.json ou similar).

Faça o commit das suas alterações: git commit -m 'feat: Adiciona o modelo [Nome da IA]'.

Envie para o seu fork: git push origin feature/adiciona-nova-ia.

Abra um Pull Request (PR) para a branch principal deste repositório.
